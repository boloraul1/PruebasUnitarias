...
public class ClaseExamen {
    ...
    private java.util.ArrayList<Integer> numeros; // referencia a la listade números 
    ...
    public int getIndiceDe(int numero) throws
        ...
        throw new java.util.NoSuchElementException(String.valueOf(numero)); // El número noexiste, lanzamos la excepción
    }
}
